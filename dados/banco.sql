...
--
-- Host: 127.0.0.1    Database: sos_acessivel2
-- ------------------------------------------------------
...
CREATE TABLE `atendentes` (
  ...
  PRIMARY KEY (`id`),
  KEY `atendentes_i_instituicao_atendimento_foreign` (`i_instituicao_atendimento`)
...
CREATE TABLE `atendimentos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `atendimentos_id_ocorrencia_foreign` (`id_ocorrencia`),
  KEY `atendimentos_id_paciente_foreign` (`id_paciente`),
  KEY `atendimentos_id_viatura_foreign` (`id_viatura`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `classificacao_ocorrencias`
--

DROP TABLE IF EXISTS `classificacao_ocorrencias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `classificacao_ocorrencias`
--

LOCK TABLES `classificacao_ocorrencias` WRITE;
/*!40000 ALTER TABLE `classificacao_ocorrencias` DISABLE KEYS */;
INSERT INTO `classificacao_ocorrencias` VALUES (1,'Acidentes e traumas',NULL,NULL),(2,'Emergências médicas',NULL,NULL),(3,'Emergências policiais',NULL,NULL),(4,'Resgates/Desastres naturais',NULL,NULL),(5,'Risco imediato à vida',NULL,NULL);
/*!40000 ALTER TABLE `classificacao_ocorrencias` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contato_emergencias`
--

DROP TABLE IF EXISTS `contato_emergencias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contato_emergencias` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `contato_emergencias_id_paciente_foreign` (`id_paciente`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contato_emergencias`
--

LOCK TABLES `contato_emergencias` WRITE;
/*!40000 ALTER TABLE `contato_emergencias` DISABLE KEYS */;
/*!40000 ALTER TABLE `contato_emergencias` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `instituicao_atendimentos`
--

DROP TABLE IF EXISTS `instituicao_atendimentos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `instituicao_atendimentos` (
  ...
  PRIMARY KEY (`id`),
  KEY `instituicao_atendimentos_id_estado_foreign` (`id_estado`),
  KEY `id_instituicao_orgao` (`id_instituicao_orgao`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `instituicao_atendimentos`
--

LOCK TABLES `instituicao_atendimentos` WRITE;
/*!40000 ALTER TABLE `instituicao_atendimentos` DISABLE KEYS */;
INSERT INTO `instituicao_atendimentos` VALUES (1,'Instituição Exemplo CBM-SC','1',24,NULL,NULL,0);
/*!40000 ALTER TABLE `instituicao_atendimentos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ocorrencias` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ocorrencias_id_paciente_foreign` (`id_paciente`),
  KEY `ocorrencias_id_tipo_ocorrencia_foreign` (`id_tipo_ocorrencia`),
  KEY `ocorrencias_id_instituicao_foreign` (`id_instituicao`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pacientes` VALUES (1,'João da Silva','1995-07-01','A','P','Avenida Centenário, 1450 Santa Bárbara Criciúma - SC','.',NULL,NULL);
...
--
-- Table structure for table `instituicao_orgaos`
--

DROP TABLE IF EXISTS `instituicao_orgaos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `instituicao_orgaos`
--

LOCK TABLES `instituicao_orgaos` WRITE;
/*!40000 ALTER TABLE `instituicao_orgaos` DISABLE KEYS */;
INSERT INTO `instituicao_orgaos` VALUES (1,'Corpo de Bombeiros Militar'),(2,'Polícia Militar'),(3,'Serviço de Atendimento Móvel de Urgência');
/*!40000 ALTER TABLE `instituicao_orgaos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tipo_ocorrencias`
--
...
CREATE TABLE `users` (
  ...
  KEY `users_id_instituicao_foreign` (`id_instituicao`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Administrador','1','admin@admin.com','$2y$10$6QPpxmPSl0fsSLfi9aTY9.rsUusF1eQMi4Mx3KpUqAEGDYamS3cUO',1,NULL,'2018-06-21 22:59:18','2018-06-21 22:59:18');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `viatura_marcas`
--

DROP TABLE IF EXISTS `viatura_marcas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `viaturas` (
  ...
  PRIMARY KEY (`id`),
  KEY `viaturas_id_modelo_foreign` (`id_modelo`)
...
INSERT INTO `viaturas` VALUES (10,'DRC-4848',180,'2018-06-22 22:58:28','2018-06-22 22:58:28',2012),(5,'MZK-9856',2655,'2018-06-22 04:00:03','2018-06-22 06:24:03',2012);
...
-- Dump completed on 2018-06-22 20:39:32
